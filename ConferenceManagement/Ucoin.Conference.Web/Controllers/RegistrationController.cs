namespace Ucoin.Conference.Web.Controllers
{
    ...
    using Ucoin.Conference.Web.Models;
    ...
    public class RegistrationController : ConferenceTenantController
    {
            ...
            if (!orderId.HasValue)
            {
                return viewModelTask
                    .ContinueWith<ActionResult>(t =>
                    {
                        ...
                        viewModel.OrderId = GuidHelper.NewSequentialId();
        ...
        private InitiateThirdPartyProcessorPayment CreatePaymentCommand(PricedOrder order)
        {
            ...
            var paymentCommand =
                ...
                {
                    PaymentId = GuidHelper.NewSequentialId(),
                    ...
                    Items =
                        seatTypes.Select(
                            s =>
                                ...
                                {
                                    SeatType = s,
                                    OrderItem = new DraftOrderItem(s.SeatTypeId, 0),
        ...
        private static void UpdateViewModel(OrderViewModel viewModel, DraftOrder order)
        {
            ...
            {
                var seat = viewModel.Items.First(s => s.SeatType.SeatTypeId == line.SeatType);
                seat.OrderItem = line;
