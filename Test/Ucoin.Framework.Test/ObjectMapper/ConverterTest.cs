...
namespace Ucoin.Framework.ObjectMapper.Test
{
    public class ConverterTest
    {
        ...
        public void TestCharConvert()
        {
            ...
            Helper.AreSequentialEqual(BitConverter.GetBytes((char)20), Mapper.Map<char, byte[]>((char)20));
        ...
        public void TestInt32Convert()
        {
            ...
            Helper.AreSequentialEqual(BitConverter.GetBytes(20), Mapper.Map<int, byte[]>(20));
        ...
        public void TestUInt32Convert()
        {
            ...
            Helper.AreSequentialEqual(BitConverter.GetBytes((uint)20), Mapper.Map<uint, byte[]>(20));
        ...
        public void TestInt16Convert()
        {
            ...
            Helper.AreSequentialEqual(BitConverter.GetBytes((short)20), Mapper.Map<short, byte[]>(20));
        ...
        public void TestUInt16Convert()
        {
            ...
            Helper.AreSequentialEqual(BitConverter.GetBytes((ushort)20), Mapper.Map<ushort, byte[]>(20));
        ...
        public void TestInt64Convert()
        {
            ...
            Helper.AreSequentialEqual(BitConverter.GetBytes((long)20), Mapper.Map<long, byte[]>(20));
        ...
        public void TestUInt64Convert()
        {
            ...
            Helper.AreSequentialEqual(BitConverter.GetBytes((ulong)20), Mapper.Map<ulong, byte[]>(20));
        ...
        public void TestDoubleConvert()
        {
            ...
            Helper.AreSequentialEqual(BitConverter.GetBytes((double)20), Mapper.Map<double, byte[]>(20));
        ...
        public void TestSingleConvert()
        {
            ...
            Helper.AreSequentialEqual(BitConverter.GetBytes((float)20), Mapper.Map<float, byte[]>(20));
        ...
        public void TestFromStringConvert()
        {
            ...
            var uri = new Uri("http://www.dextrys.com");
            ...
            Assert.Equal(zone.Id, Mapper.Map<string, TimeZoneInfo>(zone.ToSerializedString()).Id);
        }
        ...
        public void TestFromByteArray()
        {
            ...
            Helper.AreSequentialEqual(guid.ToByteArray(), Mapper.Map<Guid, byte[]>(guid));

            Helper.AreSequentialEqual(IPAddress.None.GetAddressBytes(), Mapper.Map<IPAddress, byte[]>(IPAddress.None));
